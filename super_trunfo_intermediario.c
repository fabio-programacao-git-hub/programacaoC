...
int main(){
    ...
    float pib_1 = 10955000.000, pib_2 = 62954000.000;
    int turismo_1 = 16, turismo_2 = 78;

    float media_1 = (float) populacao_1 / area_1;
    float media_1_1 = (float) pib_1 / populacao_1;
    float media_2 = (float) populacao_2 / area_2;
    float media_2_2 = (float) pib_2 / populacao_2;
